...
pipe = Pipeline([('SVC-OvsA', OneVsRestClassifier(svm.SVC(), n_jobs=-1))])
param_grid = [{'SVC-OvsA__estimator__C': [2**i for i in xrange(-5, 11)], 
                'SVC-OvsA__estimator__gamma':[2**i for i in xrange(-15, 1)]}]
